...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println("************Listing book written by kevin*************");
		for(Book book:service.getAuthorBooks("kevin") ) {
			System.out.println(book);
		}
		
		System.out.println("************Listing book on hacking*************");
		for(Book book:service.getBookByTitle("hacking")) {
			System.out.println(book);
		}
